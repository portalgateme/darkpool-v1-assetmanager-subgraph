...
export class CurveFSNAddLiquidityAssetManager extends ethereum.SmartContract {
  static bind(address: Address): CurveFSNAddLiquidityAssetManager {
    return new CurveFSNAddLiquidityAssetManager(
