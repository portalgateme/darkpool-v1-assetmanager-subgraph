...
export class BatchJoinSplit extends ethereum.Event {
  get params(): BatchJoinSplit__Params {
    return new BatchJoinSplit__Params(this);
  }
}

export class BatchJoinSplit__Params {
  _event: BatchJoinSplit;

  constructor(event: BatchJoinSplit) {
    this._event = event;
  }
...
export class BatchJoinSplitAssetManager extends ethereum.SmartContract {
  static bind(address: Address): BatchJoinSplitAssetManager {
    return new BatchJoinSplitAssetManager(
      "BatchJoinSplitAssetManager",
      address,
    );
  }
...
export class BatchJoinSplitCall extends ethereum.Call {
  get inputs(): BatchJoinSplitCall__Inputs {
    return new BatchJoinSplitCall__Inputs(this);
  }

  get outputs(): BatchJoinSplitCall__Outputs {
    return new BatchJoinSplitCall__Outputs(this);
  }
}

export class BatchJoinSplitCall__Inputs {
  _call: BatchJoinSplitCall;

  constructor(call: BatchJoinSplitCall) {
    this._call = call;
  }
  ...
  get _nullifiersIn(): Array<Bytes> {
    return this._call.inputValues[1].value.toBytesArray();
  }

  get _notesOut(): Array<Bytes> {
    return this._call.inputValues[2].value.toBytesArray();
  }

  get _noteFooters(): Array<Bytes> {
...
export class BatchJoinSplitCall__Outputs {
  _call: BatchJoinSplitCall;
