...
export class SablierDynamicAssetManager extends ethereum.SmartContract {
  static bind(address: Address): SablierDynamicAssetManager {
    return new SablierDynamicAssetManager(
      "SablierDynamicAssetManager",
      address,
    );
  }
...
export class CreateDynamicStreamCall extends ethereum.Call {
  get inputs(): CreateDynamicStreamCall__Inputs {
    return new CreateDynamicStreamCall__Inputs(this);
  }

  get outputs(): CreateDynamicStreamCall__Outputs {
    return new CreateDynamicStreamCall__Outputs(this);
  }
}

export class CreateDynamicStreamCall__Inputs {
  _call: CreateDynamicStreamCall;

  constructor(call: CreateDynamicStreamCall) {
    this._call = call;
  }
  ...
  get _args(): CreateDynamicStreamCall_argsStruct {
    return changetype<CreateDynamicStreamCall_argsStruct>(
      this._call.inputValues[1].value.toTuple(),
    );
  }
}

export class CreateDynamicStreamCall__Outputs {
  _call: CreateDynamicStreamCall;
...
export class CreateDynamicStreamCall_argsStruct extends ethereum.Tuple {
  get assetIn(): Address {
  ...
  get streamParams(): Array<CreateDynamicStreamCall_argsStreamParamsStruct> {
    return this[4].toTupleArray<CreateDynamicStreamCall_argsStreamParamsStruct>();
  }
...
export class CreateDynamicStreamCall_argsStreamParamsStruct extends ethereum.Tuple {
  get amount(): BigInt {
  ...
  get segments(): Array<CreateDynamicStreamCall_argsStreamParamsSegmentsStruct> {
    return this[4].toTupleArray<CreateDynamicStreamCall_argsStreamParamsSegmentsStruct>();
  }
}

export class CreateDynamicStreamCall_argsStreamParamsSegmentsStruct extends ethereum.Tuple {
  get amount(): BigInt {
    return this[0].toBigInt();
  }
