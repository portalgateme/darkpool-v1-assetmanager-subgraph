...
export class TorosDeposit extends ethereum.Event {
  get params(): TorosDeposit__Params {
    return new TorosDeposit__Params(this);
  }
}

export class TorosDeposit__Params {
  _event: TorosDeposit;

  constructor(event: TorosDeposit) {
    this._event = event;
  }
...
export class TorosWithdrawal extends ethereum.Event {
  get params(): TorosWithdrawal__Params {
    return new TorosWithdrawal__Params(this);
  }
}

export class TorosWithdrawal__Params {
  _event: TorosWithdrawal;

  constructor(event: TorosWithdrawal) {
    this._event = event;
  }
...
export class TorosAssetManager extends ethereum.SmartContract {
  static bind(address: Address): TorosAssetManager {
    return new TorosAssetManager("TorosAssetManager", address);
  }
  ...
  getCommissionPercentOnProfit(): BigInt {
    let result = super.call(
      "getCommissionPercentOnProfit",
      "getCommissionPercentOnProfit():(uint256)",
      [],
    );
  ...
  try_getCommissionPercentOnProfit(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getCommissionPercentOnProfit",
      "getCommissionPercentOnProfit():(uint256)",
      [],
  ...
  getTorosTokenCurrentPrice(_nftId: BigInt): BigInt {
    let result = super.call(
      "getTorosTokenCurrentPrice",
      "getTorosTokenCurrentPrice(uint256):(uint256)",
  ...
  try_getTorosTokenCurrentPrice(_nftId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getTorosTokenCurrentPrice",
      "getTorosTokenCurrentPrice(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_nftId)],
  ...
  getTorosTokenOpenPrice(_nftId: BigInt): BigInt {
    let result = super.call(
      "getTorosTokenOpenPrice",
      "getTorosTokenOpenPrice(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_nftId)],
    );
  ...
  try_getTorosTokenOpenPrice(_nftId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getTorosTokenOpenPrice",
      "getTorosTokenOpenPrice(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_nftId)],
  ...
  torosPools(torosPool: Address): Address {
    let result = super.call("torosPools", "torosPools(address):(address)", [
      ethereum.Value.fromAddress(torosPool),
    ]);

    return result[0].toAddress();
  }

  try_torosPools(torosPool: Address): ethereum.CallResult<Address> {
    let result = super.tryCall("torosPools", "torosPools(address):(address)", [
      ethereum.Value.fromAddress(torosPool),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class AddTorosPoolCall extends ethereum.Call {
  get inputs(): AddTorosPoolCall__Inputs {
    return new AddTorosPoolCall__Inputs(this);
  }

  get outputs(): AddTorosPoolCall__Outputs {
    return new AddTorosPoolCall__Outputs(this);
  }
}

export class AddTorosPoolCall__Inputs {
  _call: AddTorosPoolCall;

  constructor(call: AddTorosPoolCall) {
    this._call = call;
  }
  ...
  get poolManger(): Address {
    return this._call.inputValues[1].value.toAddress();
  }
}

export class AddTorosPoolCall__Outputs {
  _call: AddTorosPoolCall;
...
export class RemoveTorosPoolCall extends ethereum.Call {
  get inputs(): RemoveTorosPoolCall__Inputs {
    return new RemoveTorosPoolCall__Inputs(this);
  }

  get outputs(): RemoveTorosPoolCall__Outputs {
    return new RemoveTorosPoolCall__Outputs(this);
  }
}

export class RemoveTorosPoolCall__Inputs {
  _call: RemoveTorosPoolCall;

  constructor(call: RemoveTorosPoolCall) {
    this._call = call;
  }
...
export class RemoveTorosPoolCall__Outputs {
  _call: RemoveTorosPoolCall;
...
export class SetCommissionPercentOnProfitCall extends ethereum.Call {
  get inputs(): SetCommissionPercentOnProfitCall__Inputs {
    return new SetCommissionPercentOnProfitCall__Inputs(this);
  }

  get outputs(): SetCommissionPercentOnProfitCall__Outputs {
    return new SetCommissionPercentOnProfitCall__Outputs(this);
  }
}

export class SetCommissionPercentOnProfitCall__Inputs {
  _call: SetCommissionPercentOnProfitCall;

  constructor(call: SetCommissionPercentOnProfitCall) {
    this._call = call;
  }
...
export class SetCommissionPercentOnProfitCall__Outputs {
  _call: SetCommissionPercentOnProfitCall;
...
export class TorosDepositCall extends ethereum.Call {
  get inputs(): TorosDepositCall__Inputs {
    return new TorosDepositCall__Inputs(this);
  }

  get outputs(): TorosDepositCall__Outputs {
    return new TorosDepositCall__Outputs(this);
  }
}

export class TorosDepositCall__Inputs {
  _call: TorosDepositCall;

  constructor(call: TorosDepositCall) {
    this._call = call;
  }
...
export class TorosDepositCall__Outputs {
  _call: TorosDepositCall;
...
export class TorosWithdrawCall extends ethereum.Call {
  get inputs(): TorosWithdrawCall__Inputs {
    return new TorosWithdrawCall__Inputs(this);
  }

  get outputs(): TorosWithdrawCall__Outputs {
    return new TorosWithdrawCall__Outputs(this);
  }
}

export class TorosWithdrawCall__Inputs {
  _call: TorosWithdrawCall;

  constructor(call: TorosWithdrawCall) {
    this._call = call;
  }
...
export class TorosWithdrawCall__Outputs {
  _call: TorosWithdrawCall;
