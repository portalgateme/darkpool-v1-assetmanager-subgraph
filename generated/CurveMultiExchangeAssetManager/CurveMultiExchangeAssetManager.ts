...
export class CurveExchange extends ethereum.Event {
  get params(): CurveExchange__Params {
    return new CurveExchange__Params(this);
  }
}

export class CurveExchange__Params {
  _event: CurveExchange;

  constructor(event: CurveExchange) {
    this._event = event;
  }
...
export class CurveMultiExchangeAssetManager extends ethereum.SmartContract {
  static bind(address: Address): CurveMultiExchangeAssetManager {
    return new CurveMultiExchangeAssetManager(
  ...
  try_ROUTER_PROVIDER(): ethereum.CallResult<Address> {
...
export class CurveMultiExchangeCall extends ethereum.Call {
  get inputs(): CurveMultiExchangeCall__Inputs {
    return new CurveMultiExchangeCall__Inputs(this);
  }

  get outputs(): CurveMultiExchangeCall__Outputs {
    return new CurveMultiExchangeCall__Outputs(this);
  }
}

export class CurveMultiExchangeCall__Inputs {
  _call: CurveMultiExchangeCall;

  constructor(call: CurveMultiExchangeCall) {
    this._call = call;
  }
  ...
  get _args(): CurveMultiExchangeCall_argsStruct {
    return changetype<CurveMultiExchangeCall_argsStruct>(
      this._call.inputValues[1].value.toTuple(),
    );
  }
}

export class CurveMultiExchangeCall__Outputs {
  _call: CurveMultiExchangeCall;
...
export class CurveMultiExchangeCall_argsStruct extends ethereum.Tuple {
  ...
  get route(): Array<Address> {
    return this[4].toAddressArray();
  }

  get swapParams(): Array<Array<BigInt>> {
