...
export class CurveMPRemoveLiquidityAssetManager extends ethereum.SmartContract {
  static bind(address: Address): CurveMPRemoveLiquidityAssetManager {
    return new CurveMPRemoveLiquidityAssetManager(
...
export class CurveRemoveLiquidityCall extends ethereum.Call {
  get inputs(): CurveRemoveLiquidityCall__Inputs {
    return new CurveRemoveLiquidityCall__Inputs(this);
  }

  get outputs(): CurveRemoveLiquidityCall__Outputs {
    return new CurveRemoveLiquidityCall__Outputs(this);
  }
}

export class CurveRemoveLiquidityCall__Inputs {
  _call: CurveRemoveLiquidityCall;

  constructor(call: CurveRemoveLiquidityCall) {
    this._call = call;
  }
  ...
  get _args(): CurveRemoveLiquidityCall_argsStruct {
    return changetype<CurveRemoveLiquidityCall_argsStruct>(
      this._call.inputValues[1].value.toTuple(),
    );
  }
}

export class CurveRemoveLiquidityCall__Outputs {
  _call: CurveRemoveLiquidityCall;
...
export class CurveRemoveLiquidityCall_argsStruct extends ethereum.Tuple {
