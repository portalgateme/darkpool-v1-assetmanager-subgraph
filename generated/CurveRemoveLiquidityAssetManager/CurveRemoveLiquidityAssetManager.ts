...
export class CurveRemoveLiquidityAssetManager extends ethereum.SmartContract {
  static bind(address: Address): CurveRemoveLiquidityAssetManager {
    return new CurveRemoveLiquidityAssetManager(
