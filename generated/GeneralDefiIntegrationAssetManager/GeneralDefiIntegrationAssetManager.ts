...
export class DefiIntegration extends ethereum.Event {
  get params(): DefiIntegration__Params {
    return new DefiIntegration__Params(this);
  }
}

export class DefiIntegration__Params {
  _event: DefiIntegration;

  constructor(event: DefiIntegration) {
    this._event = event;
  }
...
export class GeneralDefiIntegrationAssetManager extends ethereum.SmartContract {
  static bind(address: Address): GeneralDefiIntegrationAssetManager {
    return new GeneralDefiIntegrationAssetManager(
      "GeneralDefiIntegrationAssetManager",
      address,
    );
  }
  ...
  MAXISUM_ASSETS_ALLOWED(): BigInt {
    let result = super.call(
      "MAXISUM_ASSETS_ALLOWED",
      "MAXISUM_ASSETS_ALLOWED():(uint256)",
      [],
    );
  ...
  try_MAXISUM_ASSETS_ALLOWED(): ethereum.CallResult<BigInt> {
...
export class DeFiIntegrateCall extends ethereum.Call {
  get inputs(): DeFiIntegrateCall__Inputs {
    return new DeFiIntegrateCall__Inputs(this);
  }

  get outputs(): DeFiIntegrateCall__Outputs {
    return new DeFiIntegrateCall__Outputs(this);
  }
}

export class DeFiIntegrateCall__Inputs {
  _call: DeFiIntegrateCall;

  constructor(call: DeFiIntegrateCall) {
    this._call = call;
  }
  ...
  get _args(): DeFiIntegrateCall_argsStruct {
    return changetype<DeFiIntegrateCall_argsStruct>(
      this._call.inputValues[1].value.toTuple(),
    );
  }
}

export class DeFiIntegrateCall__Outputs {
  _call: DeFiIntegrateCall;
...
export class DeFiIntegrateCall_argsStruct extends ethereum.Tuple {
  ...
  get amountsOrNftIds(): Array<BigInt> {
  ...
  get defiParameters(): string {
    return this[6].toString();
  }

  get defiParametersHash(): Bytes {
