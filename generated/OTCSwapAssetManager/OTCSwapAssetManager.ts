...
export class OTCSwapAssetManager extends ethereum.SmartContract {
  static bind(address: Address): OTCSwapAssetManager {
    return new OTCSwapAssetManager("OTCSwapAssetManager", address);
  }
