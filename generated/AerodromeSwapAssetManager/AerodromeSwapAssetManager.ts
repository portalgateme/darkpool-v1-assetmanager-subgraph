...
export class AerodromeSwap extends ethereum.Event {
  get params(): AerodromeSwap__Params {
    return new AerodromeSwap__Params(this);
  }
}

export class AerodromeSwap__Params {
  _event: AerodromeSwap;

  constructor(event: AerodromeSwap) {
    this._event = event;
  }
...
export class AerodromeSwapAssetManager extends ethereum.SmartContract {
  static bind(address: Address): AerodromeSwapAssetManager {
    return new AerodromeSwapAssetManager("AerodromeSwapAssetManager", address);
  }
...
export class AerodromeSwapCall extends ethereum.Call {
  get inputs(): AerodromeSwapCall__Inputs {
    return new AerodromeSwapCall__Inputs(this);
  }

  get outputs(): AerodromeSwapCall__Outputs {
    return new AerodromeSwapCall__Outputs(this);
  }
}

export class AerodromeSwapCall__Inputs {
  _call: AerodromeSwapCall;

  constructor(call: AerodromeSwapCall) {
    this._call = call;
  }
  ...
  get _args(): AerodromeSwapCall_argsStruct {
    return changetype<AerodromeSwapCall_argsStruct>(
      this._call.inputValues[1].value.toTuple(),
    );
  }
}

export class AerodromeSwapCall__Outputs {
  _call: AerodromeSwapCall;
...
export class AerodromeSwapCall_argsStruct extends ethereum.Tuple {
  ...
  get route(): Array<AerodromeSwapCall_argsRouteStruct> {
    return this[4].toTupleArray<AerodromeSwapCall_argsRouteStruct>();
  }
  ...
  get minExpectedAmountOut(): BigInt {
...
export class AerodromeSwapCall_argsRouteStruct extends ethereum.Tuple {
  get from(): Address {
