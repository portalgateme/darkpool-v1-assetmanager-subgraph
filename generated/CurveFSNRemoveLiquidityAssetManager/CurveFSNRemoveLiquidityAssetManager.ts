...
export class CurveFSNRemoveLiquidityAssetManager extends ethereum.SmartContract {
  static bind(address: Address): CurveFSNRemoveLiquidityAssetManager {
    return new CurveFSNRemoveLiquidityAssetManager(
