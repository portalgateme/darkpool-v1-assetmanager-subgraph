...
export class CurveSingleExchangeAssetManager extends ethereum.SmartContract {
  static bind(address: Address): CurveSingleExchangeAssetManager {
    return new CurveSingleExchangeAssetManager(
...
export class CurveSingleExchangeCall extends ethereum.Call {
  get inputs(): CurveSingleExchangeCall__Inputs {
    return new CurveSingleExchangeCall__Inputs(this);
  }

  get outputs(): CurveSingleExchangeCall__Outputs {
    return new CurveSingleExchangeCall__Outputs(this);
  }
}

export class CurveSingleExchangeCall__Inputs {
  _call: CurveSingleExchangeCall;

  constructor(call: CurveSingleExchangeCall) {
    this._call = call;
  }
  ...
  get _args(): CurveSingleExchangeCall_argsStruct {
    return changetype<CurveSingleExchangeCall_argsStruct>(
      this._call.inputValues[1].value.toTuple(),
    );
  }
}

export class CurveSingleExchangeCall__Outputs {
  _call: CurveSingleExchangeCall;
...
export class CurveSingleExchangeCall_argsStruct extends ethereum.Tuple {
