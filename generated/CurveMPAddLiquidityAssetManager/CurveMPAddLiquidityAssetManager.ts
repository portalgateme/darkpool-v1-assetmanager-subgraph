...
export class CurveMPAddLiquidityAssetManager extends ethereum.SmartContract {
  static bind(address: Address): CurveMPAddLiquidityAssetManager {
    return new CurveMPAddLiquidityAssetManager(
