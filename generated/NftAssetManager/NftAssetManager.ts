...
export class NftWithdraw extends ethereum.Event {
  get params(): NftWithdraw__Params {
    return new NftWithdraw__Params(this);
  }
}

export class NftWithdraw__Params {
  _event: NftWithdraw;

  constructor(event: NftWithdraw) {
    this._event = event;
  }
...
export class NftAssetManager extends ethereum.SmartContract {
  static bind(address: Address): NftAssetManager {
    return new NftAssetManager("NftAssetManager", address);
  }
...
export class NftWithdrawCall extends ethereum.Call {
  get inputs(): NftWithdrawCall__Inputs {
    return new NftWithdrawCall__Inputs(this);
  }

  get outputs(): NftWithdrawCall__Outputs {
    return new NftWithdrawCall__Outputs(this);
  }
}

export class NftWithdrawCall__Inputs {
  _call: NftWithdrawCall;

  constructor(call: NftWithdrawCall) {
    this._call = call;
  }
...
export class NftWithdrawCall__Outputs {
  _call: NftWithdrawCall;
